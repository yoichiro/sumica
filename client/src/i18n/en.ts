...
export const en: typeof ja = {
  ...
  controlPanel: {
    ...
    videoDimensionModeLabel: 'Width & height',
    videoDimensionModeInherit: 'Inherit from source',
    videoDimensionModeFixed: 'Fixed values',
    videoDimensionModeInheritHint: 'Each video is generated at the source image resolution (after Hires).',
  ...
  preview: {
    ...
    emptyStateTitle: 'Generated content preview 🖼️🎬',
    emptyStateBody: 'Once you generate an image or video, the preview will appear here.',
