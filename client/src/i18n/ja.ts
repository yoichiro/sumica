export const ja = {
  ...
  controlPanel: {
    ...
    videoDimensionModeLabel: '幅と高さ',
    videoDimensionModeInherit: '元画像に合わせる',
    videoDimensionModeFixed: '固定値',
    videoDimensionModeInheritHint: '各動画は元画像の解像度（Hires 適用後）に合わせて生成されます。',
  ...
  preview: {
    ...
    emptyStateTitle: '生成コンテンツのプレビュー 🖼️🎬',
    emptyStateBody: '画像や動画を生成すると、ここにプレビューが表示されます。',
  ...
  lightbox: {
    ...
    slideshowStartTooltip: (seconds: number) => `スライドショー開始 (P) — ${seconds}秒毎に進む`,
    slideshowCycleIntervalHint: '右クリックで間隔を切替',
